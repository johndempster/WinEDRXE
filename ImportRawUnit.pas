...
begin
    ...
    ImportFile.MaxADCValue := Min(Round(edMaxADCValue.Value),SampleADCLimit) ;
    ImportFile.MinADCValue := -ImportFile.MaxADCValue - 1 ;
    ...
    for ch := 0 to ImportFile.NumChannelsPerScan-1 do begin
         ImportFile.ChannelADCVoltageRange[ch] := 1.0 ;
