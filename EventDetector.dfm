object EventDetFrm: TEventDetFrm
  ...
  DesignSize = (
    ...
    746)
  TextHeight = 15
  object edDisplayKeyPressSource: TEdit
    Left = 638
    Top = 34
    Width = 65
    Height = 23
    TabOrder = 1
    Text = 'edDisplayKeyPressSource'
    OnKeyDown = edDisplayKeyPressSourceKeyDown
  end
      ...
      object EditEventsGrp: TGroupBox
        ...
        object AnalysisGrp: TGroupBox
          ...
          object gpTDecay: TGroupBox
            ...
            object edTDecayTo: TValidatedEdit
              Left = 92
              Top = 67
              Width = 76
              Height = 21
              Hint = 'Decay to % of peak or absolute signal level '
              OnKeyPress = edTDecayToKeyPress
              AutoSize = False
              ShowHint = True
              Text = ' 90 %'
            ...
            object cbDecayFrom: TComboBox
              ...
              Width = 76
              Height = 23
              Hint = 'Waveform point to measure decay from '
              Style = csDropDownList
              Font.Charset = ANSI_CHARSET
              Font.Color = clWindowText
              Font.Height = -12
            ...
            object cbDecayTo: TComboBox
              Left = 92
              Top = 38
              Width = 76
              Height = 23
              Hint = 'Waveform point to decay to (% of peak or absolute level)'
              Style = csDropDownList
              Font.Charset = ANSI_CHARSET
              Font.Color = clWindowText
              Font.Height = -12
